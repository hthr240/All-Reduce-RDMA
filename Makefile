...
SRC := ring_allreduce.c pg_verbs.c pg_bootstrap.c pg_cli.c pg_log.c pg_reduction.c pg_collective.c
OBJ := $(SRC:.c=.o)
COURSE_TEST := test
...
tests/test_phase%: tests/test_phase%.c pg_verbs.c pg_bootstrap.c pg_cli.c pg_log.c pg_reduction.c pg_collective.c
	$(CC) $(CFLAGS) $(CPPFLAGS) -o $@ $< pg_verbs.c pg_bootstrap.c pg_cli.c pg_log.c pg_reduction.c pg_collective.c $(LDLIBS)
